...
const canvasCurvasBezier = document.getElementById("canvasCurvasBezier");
const canvasCurvasCúbicasBezier = document.getElementById("canvasCurvasCúbicasBezier");
const canvasRectanguloCombinaciones = document.getElementById("canvasRectanguloCombinaciones");
...
function drawFeather() {
  ...
  function drawCurvasBezier() {
    const canvasCurvasBezier = document.getElementById("canvasCurvasBezier");
    if (canvasCurvasBezier.getContext) {
      const ctx = canvasCurvasBezier.getContext("2d");
  ...
  function drawCurvasCúbicasBezier() {
    if (canvasCurvasCúbicasBezier.getContext) {
      const ctx = canvasCurvasCúbicasBezier.getContext("2d");
  ...
  function drawRectanguloCombinaciones() {
 
    if (canvasRectanguloCombinaciones.getContext) {
      const ctx = canvasRectanguloCombinaciones.getContext("2d");
  ...
  function drawTriangle2() {
    const ctx = canvasTriangle2.getContext("2d");
    ctx.fillStyle = "blue";
    if (canvasTriangle2.getContext) {
        ctx.fillStyle = "brown";
        ctx.beginPath();
        ctx.moveTo(100, 30);
        ctx.lineTo(100, 100);
...
drawArcos();
drawCurvasBezier();
drawCurvasCúbicasBezier();
drawRectanguloCombinaciones();
drawPath2D();
drawTriangle2();